...
import { Addcharacter } from "./components/Addcharacters";
...
export default function App() {
  ...
  return (
    ...
    <AppBar position="static" className="tabcolor">
      ...
      <Routes>
      <Route exact path="/character/edit/:id" element={<Editcharacter character={character} setcharacters={setcharacters} />}>
        </Route>
        <Route path="/character" element={<CharacterList character_list={character} setcharacters={setcharacters}></CharacterList>}>
      
        </Route>
        <Route exact path="/" element={<Home />}>
          
        </Route>
        <Route exact path="/addcharacter" element={<Addcharacter character={character} setcharacters={setcharacters} />}>
        </Route>
